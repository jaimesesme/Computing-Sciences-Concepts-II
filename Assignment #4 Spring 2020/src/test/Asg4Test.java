...
class Asg4Test {
	...
	public void testCopyStringArray() {
		System.out.println("\n--------------------\nTest of copyStringArray()"); 
		String [] list1= { "appLE","APPle","apple", "orange", "banana"};
		String [] list2 = { "silly cat", "Big Cat", "Little cat", "crazY caT"};
		String [] list3= {"Seu"};
		String [] list4 = {};

		String [] copy = ArrayExamples.copyStringArray(list4);
		assertTrue(copy.length == list4.length);
		copy = ArrayExamples.copyStringArray(list3);
		assertTrue(copy.length == list3.length);
		System.out.println("list3:");
		utils.MyUtils.showStringArray(list3, list3.length);
		System.out.println("copy:");
		utils.MyUtils.showStringArray(copy, copy.length);
		for(int i=0; i<list3.length; i++)
		{
			assertEquals(copy[i],list3[i]);
		}
		copy = ArrayExamples.copyStringArray(list2);
		assertTrue(copy.length == list2.length);
		for(int i=0; i<list2.length; i++)
		{
			assertEquals(copy[i],list2[i]);
		}
		System.out.println("list2:");
		utils.MyUtils.showStringArray(list2, list2.length);
		System.out.println("copy:");
		utils.MyUtils.showStringArray(copy, copy.length);
		copy = ArrayExamples.copyStringArray(list1);
		System.out.println("list1:");
		utils.MyUtils.showStringArray(list1, list1.length);
		System.out.println("copy:");
		utils.MyUtils.showStringArray(copy, copy.length);
		assertTrue(copy.length == list1.length);
		for(int i=0; i<list1.length; i++)
		{
			assertEquals(copy[i],list1[i]);
		}
		System.out.println("\n---------------------------\nEnd of testCopyStringArray()");
	}
	...
	public void testResetArray()
	{
		...
		ArrayExamples.printArray(list,  list.length);
		ArrayExamples.resetArray(list);
		...
		System.out.println("array list after reset: ");
		ArrayExamples.printArray(list,  list.length);
		int []list8 = {1000};
		System.out.println("array list8: ");
		ArrayExamples.printArray(list8,  list8.length);
		ArrayExamples.resetArray(list8);
		for(int i=0; i<list8.length; i++)
		{
			assertEquals(0, list8[i]);
		}
		System.out.println("array list8 after reset: ");
		ArrayExamples.printArray(list8,  list8.length);
		int [] list9 = {};
		System.out.println("array list9: ");
		ArrayExamples.printArray(list9,  list9.length);
		ArrayExamples.resetArray(list9);
		System.out.println("array After reset list9: ");
		ArrayExamples.printArray(list9,  list9.length);
	...
	public void testGetArraySum()
	{
		...
		System.out.println("array list: ");
		ArrayExamples.printArray(list, list.length);
		int sum = ArrayExamples.getSum(list, list.length);
		System.out.println("sum of all 3 values in list: " +sum);
		assertEquals(600, sum);
		sum = ArrayExamples.getSum(list, 2);
		assertEquals(300, sum);
		System.out.println("sum of first 2 values in list: " +sum);
		sum = ArrayExamples.getSum(list, 1);
		assertEquals(100, sum);
		System.out.println("sum of first value only in list: " +sum);
		sum = ArrayExamples.getSum(list, 0);
		assertEquals(0, sum);
		System.out.println("sum of 0 values in list: " +sum);
	}
