...
public class MyNode <DataType> {
  public DataType data;       // the data portion of a MyNode (public since this is only used by use within a class implementation)
  public MyNode<DataType> link; // the link portion of a MyNode (public since this is only used by use within a class implementation)
